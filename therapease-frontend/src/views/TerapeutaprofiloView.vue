            ...
            <section>
              <div class="row">
                <div class="col-lg-4">
                  ...
                  <div class="card mb-4">
                    <h3 class="clienti-associati"><strong>Clienti Associati</strong></h3>
                    <div class="card-body">
                      <div class="d-flex align-items-center">
                        <div class="flex-shrink-0"><img class="avatar avatar-lg p-1" src="../assets/profilePic.webp" alt="Jassa Rich"></div>
                        <div class="flex-grow-1 ps-3">
                          <h4>Tizio Caio</h4>
                          <button class="btn btn-outline-dark btn-sm"><span class="fab fa-twitter"></span> Visita Profilo</button>
